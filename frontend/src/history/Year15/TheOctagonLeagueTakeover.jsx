const TheOctagonLeagueTakeover = () => {
    return ( 
        ...
        On Day 166, the galaxy would observe the re-emergence of crime lord Ximaro Jix, taking over the Octagon League with deadly force, alongside Defiler Cell Leader Zane Apex and several other cell members.<br/><br/>
        During the events that led to this takeover, Leader Gamba Jaboli was captured by Ximaro personally and given the option to hand over The Octagon League to the criminal collective for which Zann Consortium resides over. Gamba made three requests during this makeover and offered Ximaro an alternative to killing him. However, the situation was unable to be resolved and Zane Apex ultimately executed Gamba Jaboli.<br/><br/>
